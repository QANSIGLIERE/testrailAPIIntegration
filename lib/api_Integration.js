var { get, post, download, post_file } = require('./api_utils.js');
...
class TestRail_API {
    ...
    async delete_dataset(dataset_id, json_body) {
        return await post(this.url, `index.php?/api/v2/delete_dataset/${dataset_id}`, json_body, this.headers, false);
    }
    ...
    async delete_case(case_id, json_body) {
        return await post(this.url, `index.php?/api/v2/delete_case/${case_id}`, json_body, this.headers, false);
    }

    async delete_cases(suite_id, json_body) {
        return await post(
            this.url,
            `index.php?/api/v2/delete_cases/${suite_id}&soft=1`,
            json_body,
            this.headers,
            false,
        );
    ...
    async delete_plan(plan_id, json_body) {
        return await post(this.url, `index.php?/api/v2/delete_plan/${plan_id}`, json_body, this.headers, false);
    }
    ...
    async delete_config(config_id, json_body) {
        return await post(this.url, `index.php?/api/v2/delete_config/${config_id}`, json_body, this.headers, false);
    }
    ...
    async get_attachment(attachment_id) {
        return await get(this.url, `index.php?/api/v2/get_attachment/${attachment_id}`, this.headers, false);
    }

    async delete_attachment(attachment_id, json_body) {
        return await post(
            this.url,
            `index.php?/api/v2/delete_attachment/${attachment_id}`,
            json_body,
            this.headers,
            false,
        );
